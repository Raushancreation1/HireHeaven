...
export const connectKafka = async () => {
    try {
        ...
        await Promise.race([
            admin.connect(),
            new Promise((_, reject) => setTimeout(() => reject(new Error("Admin connection timeout")), 10000))
        ]);
        ...
        await Promise.race([
            producer.connect(),
            new Promise((_, reject) => setTimeout(() => reject(new Error("Producer connection timeout")), 10000))
        ]);
